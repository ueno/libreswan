...
#define S(E) [E - OAKLEY_GROUP_NONE] = #E
	...
	S(OAKLEY_GROUP_ML_KEM_512), /* draft-kampanakis-ml-kem-ikev2 */
	S(OAKLEY_GROUP_ML_KEM_768), /* draft-kampanakis-ml-kem-ikev2 */
	S(OAKLEY_GROUP_ML_KEM_1024), /* draft-kampanakis-ml-kem-ikev2 */
